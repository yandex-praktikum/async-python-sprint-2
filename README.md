...
2. Используйте корутины и генераторы при решении. Использование потоков и процессов не запрещено, но база решения должна строиться на использовании корутин.
